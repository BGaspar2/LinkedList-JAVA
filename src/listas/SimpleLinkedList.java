...
public class SimpleLinkedList <E> {
	...
	public double prom () {
		...
		Node <Estudiantes> tmp = (Node<Estudiantes>) head;
	...
	//mayor de todos los estudiantes
	
	public String mayorElemento() {
		@SuppressWarnings("unchecked")
	...
	//mostrar todos
		public void getAllEst() {
			@SuppressWarnings("unchecked")
			Node <Estudiantes> tmp = (Node<Estudiantes>) head; //me ubico en la cabeza de la lista
			//recorrer
			while(tmp != null) {
